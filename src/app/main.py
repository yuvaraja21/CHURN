...
def gradio_interface(
   ...
   """ 
   Gradio interface function that processes form inputs and return prediction.
...
demo = gr.Interface(
    ...
    inputs = [
        ...
        # Internet Service section (key churn prediction)
        ...
        gr.Number(label="Monthly Charges ($)", value=85., minimum=0, maximum=200),
    ...
    Fill in the details to get a churn prediction.
    """,
    examples= [
        ...
        ["Male","Yes","Yes","No","Yes","DSL","Yes","Yes","Yes",
...
# IMPORTANT : This must ne the final line to properly integrate Gradio with FastAPI
app = gr.mount_gradio_app(
    app,        # FastAPI application instance
    demo,       # Gradio interface
    path="/ui"  #URL Path where Gradio will be accesible
)